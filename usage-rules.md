...
This file is the prescriptive DO / NEVER contract for working in Molt. Narrative, rationale, and FAQs live in `AGENTS.md` and project technical docs. Each file has one job.
