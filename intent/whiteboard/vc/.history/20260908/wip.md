...
# Validation Claude (vc) -- session of 2026-09-08, archived

Settled work and settled decisions. Everything here is EXECUTED: the code is on
`upstream/main` at Molt `d8c7c67` and Molt-matts `f2a4642`. Nothing in this file
is a live directive -- what was still unexecuted stayed on the live board.
