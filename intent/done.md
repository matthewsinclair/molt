...
- Suite 179 -> 198, every run under both `/bin/bash` 3.2 and Homebrew bash 5.3, with negative controls against the pre-fix code for 0006 and 0007.
- Commits: `549678e`, `5e99235`, `6e0e4bf`, `cd660db`, `cb907e9`, `8c3bd5a` (molt)
